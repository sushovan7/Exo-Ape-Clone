...
function Footer() {
  return (
    <div className='w-100% h-screen overflow-hidden bg-black px-7 py-16 sm:p-20 flex flex-col items-start justify-center gap-4 text-[#E0CCBB]'>
        <div className='flex items-center gap-40 overflow-hidden rounded-md mb-7'>
            <h1 className='w-40% sm:text-9xl text-6xl '>Our Story</h1>
            <video autoPlay loop muted className='w-50%' src="https://cdn.dribbble.com/users/4210486/screenshots/18120551/media/9adb3522e6ae76a0126db802da4be6d5.mp4"></video>
        </div>
