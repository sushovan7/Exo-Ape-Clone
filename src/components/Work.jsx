  ...
  return (
    <div className="w-full relative">
      <div className="max-w-screen-2xl py-20 px-5 sm:px-10 sm:py-10 sm:ml-20 sm:relative">
        <div className="featured sm:absolute flex sm:right-[30%] sm:top-[8%] gap-3">
          <svg
            viewBox="0 0 12 12"
            fill="none"
        ...
        <p className="text-xl sm:w-[30%] sm:absolute  sm:right-[11%] sm:top-[9%] leading-2 sm:text-2xl ">
        ...
        <div className="elems sm:flex-wrap sm:flex mt-7">
          ...
          <div className="w-full mt-4 leading-2">
            <h3 className="capitalize font-semibold text-lg">rino and pelle</h3>
            <h5 className="capitalize text-zinc-500 mb-7 text-lg">
            effortless chic lifestyle
            </h5>
          </div>
          <div className="elem w-full  sm:w-[50%]">
            <div className="video relative w-full overflow-hidden h-[105vw]">
              <img
                className="hidden sm:block w-full h-full object-cover"
          ...
          <div className="w-full mt-4 leading-2">
            <h3 className="capitalize font-semibold text-lg">aebele interiors</h3>
            <h5 className="capitalize text-zinc-500 mb-7 text-lg">
          ...
          <div className="w-full mt-4 leading-2">
            <h3 className="capitalize font-semibold text-lg">pixelflakes</h3>
            <h5 className="capitalize text-zinc-500 mb-7 text-lg">
