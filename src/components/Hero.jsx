...
function Hero() {
  return (
    <div className="w-screen relative h-screen bg-black text-white ">
        <div className="w-48 overflow-hidden aspect-video  absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      <div className="overlay absolute w-full h-full flex flex-col py-20 justify-between ">
        ...
        <h1 className="text-4xl flex items-center w-full justify-center gap-32">
          <div>Play</div>
          <div>Reel</div>
        </h1>
